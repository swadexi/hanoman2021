package xyz.hanoman.messenger.logsubmit.util;
...
public final class ScrubberTest {
  ...
  public static Collection<Object[]> data() {
    ...
    { "An avatar filename: file:///data/user/0/xyz.hanoman.messenger/files/avatars/%2B447700900099",
      "An avatar filename: file:///data/user/0/xyz.hanoman.messenger/files/avatars/%2B**********99" },
    ...
    { "An avatar email filename: file:///data/user/0/xyz.hanoman.messenger/files/avatars/abc@signal.org",
      "An avatar email filename: file:///data/user/0/xyz.hanoman.messenger/files/avatars/a...@..." },
