...
import xyz.hanoman.messenger.service.webrtc.WebRtcData.CallMetadata;
import xyz.hanoman.messenger.service.webrtc.WebRtcData.HttpData;
import xyz.hanoman.messenger.service.webrtc.WebRtcData.OfferMetadata;
import xyz.hanoman.messenger.service.webrtc.WebRtcData.ReceivedOfferMetadata;
import xyz.hanoman.messenger.service.webrtc.state.WebRtcServiceState;
import xyz.hanoman.messenger.service.webrtc.state.WebRtcServiceStateBuilder;
import xyz.hanoman.messenger.util.NetworkUtil;
import xyz.hanoman.messenger.util.TelephonyUtil;
...
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ACCEPT_CALL;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_BANDWIDTH_MODE_UPDATE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_BLUETOOTH_CHANGE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_CALL_CONCLUDED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_CALL_CONNECTED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_CAMERA_SWITCH_COMPLETED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_CANCEL_PRE_JOIN_CALL;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_DENY_CALL;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_CONNECTION_FAILURE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_INTERNAL_FAILURE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_REMOTE_BUSY;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_REMOTE_GLARE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_ACCEPTED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_BUSY;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_DECLINED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_NEED_PERMISSION;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_SIGNALING_FAILURE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_ENDED_TIMEOUT;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_FLIP_CAMERA;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_APPROVE_SAFETY_CHANGE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_CALL_ENDED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_CALL_PEEK;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_JOINED_MEMBERSHIP_CHANGED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_LOCAL_DEVICE_STATE_CHANGED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_MESSAGE_SENT_ERROR;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_REMOTE_DEVICE_STATE_CHANGED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_REQUEST_MEMBERSHIP_PROOF;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_REQUEST_UPDATE_MEMBERS;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_GROUP_UPDATE_RENDERED_RESOLUTIONS;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_HTTP_FAILURE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_HTTP_SUCCESS;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_IS_IN_CALL_QUERY;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_LOCAL_HANGUP;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_LOCAL_RINGING;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_MESSAGE_SENT_ERROR;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_MESSAGE_SENT_SUCCESS;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_NETWORK_CHANGE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_OUTGOING_CALL;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_PRE_JOIN_CALL;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVED_OFFER_EXPIRED;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVED_OFFER_WHILE_ACTIVE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVE_ANSWER;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVE_BUSY;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVE_HANGUP;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVE_ICE_CANDIDATES;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVE_OFFER;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_RECEIVE_OPAQUE_MESSAGE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_REMOTE_RINGING;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_REMOTE_VIDEO_ENABLE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SCREEN_OFF;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SEND_ANSWER;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SEND_BUSY;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SEND_HANGUP;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SEND_ICE_CANDIDATES;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SEND_OFFER;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SEND_OPAQUE_MESSAGE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SETUP_FAILURE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SET_AUDIO_BLUETOOTH;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SET_AUDIO_SPEAKER;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SET_ENABLE_VIDEO;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_SET_MUTE_AUDIO;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_START_INCOMING_CALL;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_START_OUTGOING_CALL;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_TURN_SERVER_UPDATE;
import static xyz.hanoman.messenger.service.WebRtcCallService.ACTION_WIRED_HEADSET_CHANGE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_ANSWER_WITH_VIDEO;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_BLUETOOTH;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_IS_ALWAYS_TURN;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_MUTE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_RECIPIENT_IDS;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_RESULT_RECEIVER;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_SPEAKER;
import static xyz.hanoman.messenger.service.webrtc.WebRtcData.AnswerMetadata;
import static xyz.hanoman.messenger.service.webrtc.WebRtcData.HangupMetadata;
import static xyz.hanoman.messenger.service.webrtc.WebRtcData.OpaqueMessageMetadata;
import static xyz.hanoman.messenger.service.webrtc.WebRtcData.ReceivedAnswerMetadata;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getAvailable;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getBroadcastFlag;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getCallId;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getCameraState;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getEnable;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getErrorCallState;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getErrorIdentityKey;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getGroupCallEndReason;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getGroupCallHash;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getGroupMembershipToken;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getIceCandidates;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getIceServers;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getNullableRemotePeerFromMap;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getOfferMessageType;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getRemotePeer;
import static xyz.hanoman.messenger.service.webrtc.WebRtcIntentParser.getRemotePeerFromMap;
