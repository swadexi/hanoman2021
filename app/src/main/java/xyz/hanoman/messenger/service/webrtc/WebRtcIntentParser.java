...
import xyz.hanoman.messenger.crypto.IdentityKeyParcelable;
...
import xyz.hanoman.messenger.ringrtc.TurnServerInfoParcel;
...
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_ANSWER_OPAQUE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_ANSWER_SDP;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_AVAILABLE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_BROADCAST;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_CALL_ID;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_CAMERA_STATE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_ENABLE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_ERROR_CALL_STATE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_ERROR_IDENTITY_KEY;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_GROUP_CALL_END_REASON;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_GROUP_CALL_HASH;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_GROUP_EXTERNAL_TOKEN;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_ICE_CANDIDATES;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_MULTI_RING;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_OFFER_OPAQUE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_OFFER_SDP;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_OFFER_TYPE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_OPAQUE_MESSAGE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_REMOTE_DEVICE;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_REMOTE_IDENTITY_KEY;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_REMOTE_PEER_KEY;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_TURN_SERVER_INFO;
import static xyz.hanoman.messenger.service.WebRtcCallService.EXTRA_UUID;
