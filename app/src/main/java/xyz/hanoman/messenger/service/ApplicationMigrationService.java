...
import xyz.hanoman.messenger.database.SmsMigrator;
import xyz.hanoman.messenger.database.SmsMigrator.ProgressDescription;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "xyz.hanoman.messenger.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "xyz.hanoman.messenger.ApplicationMigrationService.COMPLETED";
