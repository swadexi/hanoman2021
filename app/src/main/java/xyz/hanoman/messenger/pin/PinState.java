...
import xyz.hanoman.messenger.jobmanager.JobTracker;
import xyz.hanoman.messenger.jobs.ClearFallbackKbsEnclaveJob;
...
import xyz.hanoman.messenger.lock.RegistrationLockReminders;
import xyz.hanoman.messenger.lock.v2.PinKeyboardType;
import xyz.hanoman.messenger.megaphone.Megaphones;
import xyz.hanoman.messenger.registration.service.KeyBackupSystemWrongPinException;
...
public final class PinState {
  ...
  /**
   * Should only be called by {@link xyz.hanoman.messenger.migrations.RegistrationPinV2MigrationJob}.
   */
  @WorkerThread
  ...
  /**
   * Should only be called by {@link xyz.hanoman.messenger.jobs.KbsEnclaveMigrationWorkerJob}.
   */
  @WorkerThread
