...
import xyz.hanoman.messenger.blurhash.BlurHashEncoder;
...
public final class AttachmentUploadJob extends BaseJob {
  ...
  public static final class Factory implements Job.Factory<AttachmentUploadJob> {
    @Override
    public @NonNull AttachmentUploadJob create(@NonNull Parameters parameters, @NonNull xyz.hanoman.messenger.jobmanager.Data data) {
