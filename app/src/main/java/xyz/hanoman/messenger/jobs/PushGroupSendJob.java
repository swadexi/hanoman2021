...
import xyz.hanoman.messenger.jobmanager.JobLogger;
...
public final class PushGroupSendJob extends PushSendJob {
  ...
  public static class Factory implements Job.Factory<PushGroupSendJob> {
    @Override
    public @NonNull PushGroupSendJob create(@NonNull Parameters parameters, @NonNull xyz.hanoman.messenger.jobmanager.Data data) {
