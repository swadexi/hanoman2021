...
import xyz.hanoman.messenger.service.SmsDeliveryListener;
...
public class SmsSendJob extends SendJob {
  ...
  public static class Factory implements Job.Factory<SmsSendJob> {
    @Override
    public @NonNull SmsSendJob create(@NonNull Parameters parameters, @NonNull xyz.hanoman.messenger.jobmanager.Data data) {
