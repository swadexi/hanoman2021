...
import xyz.hanoman.messenger.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link xyz.hanoman.messenger.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
