...
import xyz.hanoman.messenger.database.model.GroupCallUpdateDetailsUtil;
...
import xyz.hanoman.messenger.sms.IncomingGroupUpdateMessage;
...
public class SmsDatabase extends MessageDatabase {
  ...
  public Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (xyz.hanoman.messenger.util.Util.isDefaultSmsProvider(context) ||
