package xyz.hanoman.messenger.database.helpers;
...
import xyz.hanoman.messenger.contacts.avatars.ContactColorsLegacy;
import xyz.hanoman.messenger.crypto.DatabaseSecret;
import xyz.hanoman.messenger.crypto.MasterSecret;
...
import xyz.hanoman.messenger.database.GroupReceiptDatabase;
import xyz.hanoman.messenger.database.IdentityDatabase;
import xyz.hanoman.messenger.database.JobDatabase;
import xyz.hanoman.messenger.database.KeyValueDatabase;
import xyz.hanoman.messenger.database.MegaphoneDatabase;
import xyz.hanoman.messenger.database.MentionDatabase;
import xyz.hanoman.messenger.database.MmsDatabase;
import xyz.hanoman.messenger.database.OneTimePreKeyDatabase;
import xyz.hanoman.messenger.database.PushDatabase;
import xyz.hanoman.messenger.database.RecipientDatabase;
import xyz.hanoman.messenger.database.RemappedRecordsDatabase;
import xyz.hanoman.messenger.database.SearchDatabase;
import xyz.hanoman.messenger.database.SessionDatabase;
import xyz.hanoman.messenger.database.SignalDatabase;
import xyz.hanoman.messenger.database.SignedPreKeyDatabase;
import xyz.hanoman.messenger.database.SmsDatabase;
import xyz.hanoman.messenger.database.SqlCipherDatabaseHook;
...
import xyz.hanoman.messenger.util.CursorUtil;
import xyz.hanoman.messenger.util.FileUtils;
import xyz.hanoman.messenger.util.Hex;
import xyz.hanoman.messenger.util.ServiceUtil;
import xyz.hanoman.messenger.util.SqlUtil;
import xyz.hanoman.messenger.util.TextSecurePreferences;
import xyz.hanoman.messenger.util.Triple;
...
public class SQLCipherOpenHelper extends SQLiteOpenHelper implements SignalDatabase {
  ...
  public xyz.hanoman.messenger.database.SQLiteDatabase getReadableDatabase() {
    return new xyz.hanoman.messenger.database.SQLiteDatabase(getReadableDatabase(databaseSecret.asString()));
  }

  public xyz.hanoman.messenger.database.SQLiteDatabase getWritableDatabase() {
    return new xyz.hanoman.messenger.database.SQLiteDatabase(getWritableDatabase(databaseSecret.asString()));
  }
