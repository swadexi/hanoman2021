...
import xyz.hanoman.messenger.components.emoji.EmojiPageViewGridAdapter.VariationSelectorListener;
import xyz.hanoman.messenger.keyvalue.SignalStore;
import xyz.hanoman.messenger.mms.GlideRequests;
import xyz.hanoman.messenger.util.ResUtil;

import java.util.LinkedList;
import java.util.List;

/**
 * A provider to select emoji in the {@link xyz.hanoman.messenger.components.emoji.MediaKeyboard}.
 */
