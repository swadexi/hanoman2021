...
import xyz.hanoman.messenger.BlockUnblockDialog;
import xyz.hanoman.messenger.ExpirationDialog;
import xyz.hanoman.messenger.GroupMembersDialog;
import xyz.hanoman.messenger.MainActivity;
import xyz.hanoman.messenger.MuteDialog;
import xyz.hanoman.messenger.PassphraseRequiredActivity;
import xyz.hanoman.messenger.PromptMmsActivity;
import xyz.hanoman.messenger.R;
import xyz.hanoman.messenger.ShortcutLauncherActivity;
import xyz.hanoman.messenger.TransportOption;
import xyz.hanoman.messenger.VerifyIdentityActivity;
import xyz.hanoman.messenger.attachments.Attachment;
import xyz.hanoman.messenger.attachments.TombstoneAttachment;
import xyz.hanoman.messenger.audio.AudioRecorder;
import xyz.hanoman.messenger.color.MaterialColor;
import xyz.hanoman.messenger.components.AnimatingToggle;
import xyz.hanoman.messenger.components.ComposeText;
import xyz.hanoman.messenger.components.ConversationSearchBottomBar;
import xyz.hanoman.messenger.components.HidingLinearLayout;
import xyz.hanoman.messenger.components.InputAwareLayout;
import xyz.hanoman.messenger.components.InputPanel;
import xyz.hanoman.messenger.components.KeyboardAwareLinearLayout.OnKeyboardShownListener;
import xyz.hanoman.messenger.components.SendButton;
import xyz.hanoman.messenger.components.TooltipPopup;
import xyz.hanoman.messenger.components.TypingStatusSender;
import xyz.hanoman.messenger.components.emoji.EmojiKeyboardProvider;
import xyz.hanoman.messenger.components.emoji.EmojiStrings;
import xyz.hanoman.messenger.components.emoji.MediaKeyboard;
import xyz.hanoman.messenger.components.identity.UnverifiedBannerView;
import xyz.hanoman.messenger.components.location.SignalPlace;
import xyz.hanoman.messenger.components.mention.MentionAnnotation;
import xyz.hanoman.messenger.components.reminder.ExpiredBuildReminder;
import xyz.hanoman.messenger.components.reminder.GroupsV1MigrationInitiationReminder;
import xyz.hanoman.messenger.components.reminder.GroupsV1MigrationSuggestionsReminder;
import xyz.hanoman.messenger.components.reminder.PendingGroupJoinRequestsReminder;
import xyz.hanoman.messenger.components.reminder.Reminder;
import xyz.hanoman.messenger.components.reminder.ReminderView;
import xyz.hanoman.messenger.components.reminder.ServiceOutageReminder;
import xyz.hanoman.messenger.components.reminder.UnauthorizedReminder;
import xyz.hanoman.messenger.contacts.ContactAccessor;
import xyz.hanoman.messenger.contacts.ContactAccessor.ContactData;
import xyz.hanoman.messenger.contacts.sync.DirectoryHelper;
import xyz.hanoman.messenger.contactshare.Contact;
import xyz.hanoman.messenger.contactshare.ContactShareEditActivity;
import xyz.hanoman.messenger.contactshare.ContactUtil;
import xyz.hanoman.messenger.contactshare.SimpleTextWatcher;
import xyz.hanoman.messenger.conversation.ConversationGroupViewModel.GroupActiveState;
import xyz.hanoman.messenger.conversation.ConversationMessage.ConversationMessageFactory;
import xyz.hanoman.messenger.conversation.ui.error.SafetyNumberChangeDialog;
import xyz.hanoman.messenger.conversation.ui.groupcall.GroupCallViewModel;
import xyz.hanoman.messenger.conversation.ui.mentions.MentionsPickerViewModel;
import xyz.hanoman.messenger.conversationlist.model.MessageResult;
import xyz.hanoman.messenger.crypto.SecurityEvent;
import xyz.hanoman.messenger.database.DatabaseFactory;
import xyz.hanoman.messenger.database.DraftDatabase;
import xyz.hanoman.messenger.database.DraftDatabase.Draft;
import xyz.hanoman.messenger.database.DraftDatabase.Drafts;
...
import xyz.hanoman.messenger.database.MentionUtil.UpdatedBodyAndMentions;
import xyz.hanoman.messenger.database.MmsSmsColumns.Types;
import xyz.hanoman.messenger.database.RecipientDatabase;
import xyz.hanoman.messenger.database.RecipientDatabase.RegisteredState;
...
import xyz.hanoman.messenger.events.GroupCallPeekEvent;
import xyz.hanoman.messenger.events.ReminderUpdateEvent;
import xyz.hanoman.messenger.giph.ui.GiphyActivity;
...
import xyz.hanoman.messenger.groups.ui.LeaveGroupDialog;
import xyz.hanoman.messenger.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity;
import xyz.hanoman.messenger.groups.ui.managegroup.ManageGroupActivity;
import xyz.hanoman.messenger.groups.ui.migration.GroupsV1MigrationInitiationBottomSheetDialogFragment;
import xyz.hanoman.messenger.groups.ui.migration.GroupsV1MigrationSuggestionsDialog;
import xyz.hanoman.messenger.insights.InsightsLauncher;
import xyz.hanoman.messenger.invites.InviteReminderModel;
import xyz.hanoman.messenger.invites.InviteReminderRepository;
import xyz.hanoman.messenger.jobs.GroupV1MigrationJob;
import xyz.hanoman.messenger.jobs.GroupV2UpdateSelfProfileKeyJob;
import xyz.hanoman.messenger.jobs.RequestGroupV2InfoJob;
...
import xyz.hanoman.messenger.linkpreview.LinkPreviewRepository;
import xyz.hanoman.messenger.linkpreview.LinkPreviewViewModel;
import xyz.hanoman.messenger.maps.PlacePickerActivity;
import xyz.hanoman.messenger.mediaoverview.MediaOverviewActivity;
import xyz.hanoman.messenger.mediasend.Media;
import xyz.hanoman.messenger.mediasend.MediaSendActivity;
import xyz.hanoman.messenger.mediasend.MediaSendActivityResult;
import xyz.hanoman.messenger.messagedetails.MessageDetailsActivity;
import xyz.hanoman.messenger.messagerequests.MessageRequestState;
import xyz.hanoman.messenger.messagerequests.MessageRequestViewModel;
import xyz.hanoman.messenger.messagerequests.MessageRequestsBottomView;
import xyz.hanoman.messenger.mms.AttachmentManager;
import xyz.hanoman.messenger.mms.AttachmentManager.MediaType;
import xyz.hanoman.messenger.mms.AudioSlide;
import xyz.hanoman.messenger.mms.DecryptableStreamUriLoader;
...
import xyz.hanoman.messenger.mms.ImageSlide;
import xyz.hanoman.messenger.mms.LocationSlide;
import xyz.hanoman.messenger.mms.MediaConstraints;
import xyz.hanoman.messenger.mms.OutgoingExpirationUpdateMessage;
import xyz.hanoman.messenger.mms.OutgoingMediaMessage;
import xyz.hanoman.messenger.mms.OutgoingSecureMediaMessage;
import xyz.hanoman.messenger.mms.QuoteId;
import xyz.hanoman.messenger.mms.QuoteModel;
...
import xyz.hanoman.messenger.mms.VideoSlide;
import xyz.hanoman.messenger.notifications.NotificationChannels;
import xyz.hanoman.messenger.permissions.Permissions;
import xyz.hanoman.messenger.profiles.spoofing.ReviewBannerView;
import xyz.hanoman.messenger.profiles.spoofing.ReviewCardDialogFragment;
import xyz.hanoman.messenger.providers.BlobProvider;
import xyz.hanoman.messenger.reactions.ReactionsBottomSheetDialogFragment;
import xyz.hanoman.messenger.reactions.any.ReactWithAnyEmojiBottomSheetDialogFragment;
import xyz.hanoman.messenger.recipients.LiveRecipient;
import xyz.hanoman.messenger.recipients.Recipient;
import xyz.hanoman.messenger.recipients.RecipientExporter;
import xyz.hanoman.messenger.recipients.RecipientFormattingException;
import xyz.hanoman.messenger.recipients.RecipientId;
import xyz.hanoman.messenger.recipients.RecipientUtil;
import xyz.hanoman.messenger.recipients.ui.managerecipient.ManageRecipientActivity;
...
import xyz.hanoman.messenger.sms.OutgoingEncryptedMessage;
import xyz.hanoman.messenger.sms.OutgoingEndSessionMessage;
...
import xyz.hanoman.messenger.stickers.StickerPackInstallEvent;
import xyz.hanoman.messenger.stickers.StickerSearchRepository;
import xyz.hanoman.messenger.util.AsynchronousCallback;
import xyz.hanoman.messenger.util.Base64;
import xyz.hanoman.messenger.util.BitmapUtil;
import xyz.hanoman.messenger.util.BubbleUtil;
import xyz.hanoman.messenger.util.CharacterCalculator.CharacterState;
...
import xyz.hanoman.messenger.util.DrawableUtil;
import xyz.hanoman.messenger.util.DynamicDarkToolbarTheme;
import xyz.hanoman.messenger.util.DynamicLanguage;
...
import xyz.hanoman.messenger.util.MessageUtil;
...
import xyz.hanoman.messenger.util.TextSecurePreferences.MediaKeyboardMode;
...
import xyz.hanoman.messenger.util.concurrent.AssertedSuccessListener;
...
import xyz.hanoman.messenger.util.views.Stub;
...
import static xyz.hanoman.messenger.TransportOption.Type;
import static xyz.hanoman.messenger.database.GroupDatabase.GroupRecord;
