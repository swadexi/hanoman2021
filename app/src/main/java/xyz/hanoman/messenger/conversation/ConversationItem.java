...
import xyz.hanoman.messenger.BindableConversationItem;
import xyz.hanoman.messenger.ConfirmIdentityDialog;
import xyz.hanoman.messenger.MediaPreviewActivity;
import xyz.hanoman.messenger.R;
import xyz.hanoman.messenger.attachments.DatabaseAttachment;
import xyz.hanoman.messenger.components.AlertView;
import xyz.hanoman.messenger.components.AudioView;
import xyz.hanoman.messenger.components.AvatarImageView;
import xyz.hanoman.messenger.components.BorderlessImageView;
import xyz.hanoman.messenger.components.ConversationItemFooter;
import xyz.hanoman.messenger.components.ConversationItemThumbnail;
import xyz.hanoman.messenger.components.DocumentView;
import xyz.hanoman.messenger.components.LinkPreviewView;
import xyz.hanoman.messenger.components.Outliner;
import xyz.hanoman.messenger.components.QuoteView;
import xyz.hanoman.messenger.components.SharedContactView;
import xyz.hanoman.messenger.components.emoji.EmojiTextView;
...
import xyz.hanoman.messenger.database.model.Quote;
...
import xyz.hanoman.messenger.linkpreview.LinkPreviewUtil;
...
import xyz.hanoman.messenger.mms.SlideClickListener;
import xyz.hanoman.messenger.mms.SlidesClickedListener;
import xyz.hanoman.messenger.mms.TextSlide;
import xyz.hanoman.messenger.reactions.ReactionsConversationView;
...
import xyz.hanoman.messenger.revealable.ViewOnceMessageView;
import xyz.hanoman.messenger.revealable.ViewOnceUtil;
import xyz.hanoman.messenger.stickers.StickerUrl;
import xyz.hanoman.messenger.util.DateUtils;
import xyz.hanoman.messenger.util.DynamicTheme;
import xyz.hanoman.messenger.util.InterceptableLongClickCopyLinkSpan;
import xyz.hanoman.messenger.util.LongClickMovementMethod;
import xyz.hanoman.messenger.util.SearchUtil;
import xyz.hanoman.messenger.util.StringUtil;
import xyz.hanoman.messenger.util.TextSecurePreferences;
import xyz.hanoman.messenger.util.UrlClickHandler;
import xyz.hanoman.messenger.util.Util;
import xyz.hanoman.messenger.util.VibrateUtil;
...
import static xyz.hanoman.messenger.util.ThemeUtil.isDarkTheme;
